...
//	public List<Evaluacion> evaluadoresDeUnTrabajo (Trabajo trabajo) {		
//		int id = trabajo.getId();
//		EntityManager entityManager = EMF.createEntityManager();	
...
//	}
	...
	public void buscarDatosTrabajo (Trabajo trabajo) {		
		...
		List<Trabajo> paper = queryTrabajo.getResultList();
		...
		List<Evaluacion> evaluaciones = queryEvaluador.getResultList();
