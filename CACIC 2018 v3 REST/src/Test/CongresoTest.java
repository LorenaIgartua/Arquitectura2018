...
//		UsuarioDAO.getInstance().update(carina.getId(), carina);
	...
	// c. Crear trabajos de investigaci�n (10 trabajos de investigaci�n).
		...
		ServiciosCongreso.getInstance().asignarEvaluador(trabajo1);
		ServiciosCongreso.getInstance().asignarEvaluador(trabajo2);
		ServiciosCongreso.getInstance().asignarEvaluador(trabajo3);
		ServiciosCongreso.getInstance().asignarEvaluador(trabajo4);
		ServiciosCongreso.getInstance().asignarEvaluador(trabajo5);
		ServiciosCongreso.getInstance().asignarEvaluador(trabajo6);
		ServiciosCongreso.getInstance().asignarEvaluador(trabajo7);
		ServiciosCongreso.getInstance().asignarEvaluador(trabajo8);
		ServiciosCongreso.getInstance().asignarEvaluador(trabajo9);
		ServiciosCongreso.getInstance().asignarEvaluador(trabajo10);
		...
		System.out.println("d. Consultar autores, revisores y trabajos de investigaci�n. En particular se debe probar:");
...
//		assertEquals(auxUsuario, lorena);
		...
		System.out.println(" ");
		System.out.println("iv. Dado un autor, retornar todos los trabajos de investigaci�n enviados.");
		...
		System.out.println(" ");
		System.out.println("f. Consultar trabajos de investigaci�n y sus propiedades.");  //ver completar mas datos
		...
		System.out.println(" ");
		System.out.println("g. Seleccionar trabajos de investigaci�n de un autor y revisor en una\r\n" + 
				"//	determinada �rea de investigaci�n utilizando consultas JPQL.");
		List<Trabajo> consulta7 = ServiciosCongreso.getInstance().buscarTrabajosSegunAutorEvaluadorTema(mujica, carito, tema1);
